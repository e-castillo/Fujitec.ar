...
!function(a) {
    ...
    function g() {
            ...
            for (g = c.seriesStack.length - 1; g >= 0; g--)
                ...
                case a.jqplot.BarRenderer:
                    ...
                    f = 0; f < h._barPoints.length; f++)
                        if (t = h._barPoints[f],
                        s = h.gridData[f],
                        j > t[0][0] && j < t[2][0] && (k > t[2][1] && k < t[0][1] || k < t[2][1] && k > t[0][1]))
                            return {
                                seriesIndex: h.index,
                                pointIndex: f,
                                gridData: s,
        ...
        this.draw = function() {
            if (this.drawIfHidden || this.target.is(":visible")) {
                ...
                if ("number" == typeof v.series1)
                    ...
                    if (v.series1.length === v.series2.length)
                        for (var x = 0, y = 0, z = 0; z < v.series1.length; z++) {
                            if (x = v.series1[z],
                            y = v.series2[z],
                            !(x !== y && u > x && u > y && "line" === t[x]._type && "line" === t[y]._type)) {
                                w = !1;
                                break
                            }
                            w = !0
                ...
                d = u; d > b; b++)
                    A = t[b],
                    B = A.renderer,
                    C = ".jqplot-point-label.jqplot-series-" + b,
                    B.animation && B.animation._supported && B.animation.show && (this._drawCount < 2 || this.animateReplot) && (D = this.target.find(C),
                    D.stop(!0, !0).hide(),
                    A.canvas._elem.stop(!0, !0).hide(),
                    A.shadowCanvas._elem.stop(!0, !0).hide(),
                    A.canvas._elem.jqplotEffect("blind", {
                        mode: "show",
                        direction: B.animation.direction
                    }, B.animation.speed),
                    A.shadowCanvas._elem.jqplotEffect("blind", {
                        mode: "show",
                        direction: B.animation.direction
                    }, B.animation.speed),
                    D.fadeIn(.8 * B.animation.speed));
                D = null ,
        ...
        g.prototype.doFillBetweenLines = function() {
            ...
            var b = this.fillBetween
              ...
              , f = 0
              , g = 0;
            if ("number" == typeof d && "number" == typeof e)
                f = e > d ? d : e,
                g = e > d ? e : d,
                a(f, g);
            else
    ...
    ,
    a.jqplot.version = "1.0.9",
    a.jqplot.revision = "d96a669",
            ...
            if ("." === c[0] || "-" === c[0]) {
                ...
                for (var f = 0, g = e.length; g > f; f++) {
                    if ("." === e[f])
                        ...
                        if ("-" !== e[f])
                            continue;c.push(a.jqplot.config.dashLength)
                    }
    ...
    a.jqplot.LineRenderer.prototype.makeGridData = function(a, b) {
        ...
        for (var f = this.renderer.bands, g = !1, h = 0; h < a.length; h++)
            null != a[h][0] && null != a[h][1] ? (this.step && h > 0 && e.push([c.call(this._xaxis, a[h][0]), d.call(this._yaxis, a[h - 1][1])]),
            e.push([c.call(this._xaxis, a[h][0]), d.call(this._yaxis, a[h][1])])) : null == a[h][0] ? (g = !0,
    ...
    a.fn.jqplotToImageCanvas = function(b) {
        ...
        function d(b, d, e, f, g, h) {
            ...
            e.split(/\s+/)), l = k.length, m = "", n = [], o = g, p = f, q = 0; l > q; q++)
                m += k[q],
                d.measureText(m).width > j && m.length > k[q].length && (n.push(q),
                m = "",
                q--);
            if (0 === n.length)
